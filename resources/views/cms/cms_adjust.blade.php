            ...
            <div class="col-md-8 new-product">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{url('/admin/update/'. $product->id)}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="stock-price" >
                                <div class="form-group cms_stock">
                                    ...
                                    <div class="col-md-6">
                                        <input style="width:70px;" id="stock" type="number" class="form-control" name="stock" value="{{$product->stock}}" required >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input style="width:70px;" id="price" type="number" class="form-control" name="price" value="{{$product->price}}" required >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea rows="4" cols="50" id="description" type="number" step="0.01" class="form-control" name="description"  required>
                                        {{$product->description}}
                                    </textarea>
                                </div>
                            </div>
